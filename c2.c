...
void *BotWorker(void *sock) 
{
	...
	char ascii_banner_line1   [1000];
	char ascii_banner_line2   [1000];
	char ascii_banner_line3   [1000];
	char ascii_banner_line4   [1000];
	char ascii_banner_line5   [1000];
	char ascii_banner_line6   [1000];
	char ascii_banner_line7   [1000];
	char ascii_banner_line8   [1000];
	char ascii_banner_line9   [1000];
	char ascii_banner_line10  [1000];
	char ascii_banner_line11  [1000];
	char ascii_banner_line12  [1000];
	char ascii_banner_line13  [1000];
	char ascii_banner_line14  [1000];
	char ascii_banner_line15  [1000];
	char ascii_banner_line16  [1000];
	char ascii_banner_line17  [1000];
	char ascii_banner_line18  [1000];
	char ascii_banner_line19  [1000];
	char ascii_banner_line20  [1000];
	char ascii_banner_line21  [1000];
	char ascii_banner_line22  [1000];
	...
	{   
		...
		else if (strncmp(buf, "INFO", 4) == 0) 
		{
			...
			sprintf(ls4,  "                  ╔╗               ╩╝╚╝╚  ╚═╝               ╔╗                  \r\n");
			sprintf(ls5,  "                   ╚╦══════════════════════════════════════╦╝                   \r\n");
			sprintf(ls6,  "                    ║               SSP Info               ║                    \r\n");
			sprintf(ls7,  "                    ╚════╦════════════════════════════╦════╝                    \r\n");
			sprintf(ls8,  "                         ║                            ║                         \r\n");
			sprintf(ls9,  "╔════════════════════════╩════════════════════════════╩════════════════════════╗\r\n");
			sprintf(ls10, "║ Masters Connected > %-68s║\n", OperatorsConnected);
			sprintf(ls11, "║ Bots Connected > %-71s║\n", BotsConnected());
			sprintf(ls12, "║ Total Attacks Ran > %-68s║\n", totalAttacks);
			sprintf(ls13, "║ SSP Version > V4.6                                                           ║\r\n");
			sprintf(ls14, "╚══════════════════════════════════════════════════════════════════════════════╝\r\n");
			sprintf(ls15, " \r\n");
			sprintf(ls16, " \r\n");
			sprintf(ls17, " \r\n");
